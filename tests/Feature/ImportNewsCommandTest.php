 ...
 *
 * Цена возврата известна поимённо: 24.08.2026 все 11 вызовов модели за сутки
 * пришлись на заглушки, которые импорт перезапускал каждое утро, — 55%
 * бесплатной квоты на страницы, которые не разберутся никогда. Обе причины с
 * тех пор устранены (потолок повторов и перевод заголовка только после
 * успешного извлечения контента), так что запись сюда можно вернуть — но это
 * решение владельца блога, а не побочный эффект рефакторинга.
 *
