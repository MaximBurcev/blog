...
class Post extends Model
{
     ...
     * такую статью переводом значит соврать про собственный текст.
     * Признак перевода — сохранённый оригинал либо успешно разобранный
     * источник.
     *
     * Имя метода говорит «machine», а плашка на странице — просто «Перевод
     * статьи с …»: слово «машинный» обесценивает материал до первого абзаца,
     * а ссылка на оригинал рядом и так объясняет происхождение текста.
     * Внутри кода признак остаётся именно машинностью перевода.
     */
